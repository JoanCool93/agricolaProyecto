    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Eliminacion de grano</h4>
            </div>
            <div class="modal-body">
                <h2 align='center'>¿Esta seguro que desea eliminar el producto a comprar?</h2>    
            </div>
            <div class="modal-footer">
                <div class ="btn">
                    {!! Form::open(['route' => ['compra.destroy', $lineaCompra->id], 'method' => 'DELETE']) !!}
                            <div>
