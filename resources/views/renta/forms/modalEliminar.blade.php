    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Eliminacion de renta</h4>
            </div>
            <div class="modal-body">
                <h2 align='center'>¿Esta seguro que desea eliminar la renta?</h2>    
            </div>
            <div class="modal-footer">
                <div class ="btn">
                    {!! Form::open(['route' => ['renta.destroy', $renta->id], 'method' => 'DELETE']) !!}
                            <div>
