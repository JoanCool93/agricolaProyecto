    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Eliminacion de grano vender</h4>
            </div>
            <div class="modal-body">
                <h2 align='center'>¿Esta seguro que desea eliminar el grano a vender?</h2>    
            </div>
            <div class="modal-footer">
                <div class ="btn">
                    {!! Form::open(['route' => ['lineaVenta.destroy', $lineaVenta->id], 'method' => 'DELETE']) !!}
                            <div>
